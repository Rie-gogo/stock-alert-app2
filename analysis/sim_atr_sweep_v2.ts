/**
 * sim_atr_sweep_v2.ts
 * sim_bc_only.tsのロジックを完全に保持し、SL/TPの計算のみをATR連動に変更。
 * エントリーロジックは一切変更なし。
 * 実行: cd /home/ubuntu/stock-alert-app && npx tsx analysis/sim_atr_sweep_v2.ts
 */
...
// === データローダー ===
const DATES = ["2026-06-17", "2026-06-18", "2026-06-19", "2026-06-22", "2026-06-24", "2026-06-25"]; // 6/23除外（データ欠損）
...
console.log("ATR連動SL/TP パラメータスイープ（B・C適用版ベース、6日間、6/23除外）");
console.log("=".repeat(80));
console.log("");
...
const SWEEP_PARAMS: AtrSlParams[] = [
  ...
  // SLのみATR連動、TP固定1.5%
  { atrPeriod: 30, mult: 2.0, minSl: 0.3, maxSl: 0.8, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×2.0 SL[0.3-0.8] TP固定1.5" },
  { atrPeriod: 30, mult: 2.5, minSl: 0.3, maxSl: 0.8, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×2.5 SL[0.3-0.8] TP固定1.5" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 0.8, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×3.0 SL[0.3-0.8] TP固定1.5" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 1.0, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×3.0 SL[0.3-1.0] TP固定1.5" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.4, maxSl: 1.0, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×3.0 SL[0.4-1.0] TP固定1.5" },
  { atrPeriod: 30, mult: 3.5, minSl: 0.3, maxSl: 1.0, rrRatio: 0, tpFixed: 1.5, mode: "atr_sl_only", label: "ATR×3.5 SL[0.3-1.0] TP固定1.5" },
  // SL・TP両方ATR連動（RR2.0）
  { atrPeriod: 30, mult: 2.5, minSl: 0.3, maxSl: 0.8, rrRatio: 2.0, tpFixed: 0, mode: "atr_both", label: "ATR×2.5 SL[0.3-0.8] RR2.0" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 0.8, rrRatio: 2.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-0.8] RR2.0" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 1.0, rrRatio: 2.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-1.0] RR2.0" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.4, maxSl: 1.0, rrRatio: 2.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.4-1.0] RR2.0" },
  // SL・TP両方ATR連動（RR2.5）
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 0.8, rrRatio: 2.5, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-0.8] RR2.5" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 1.0, rrRatio: 2.5, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-1.0] RR2.5" },
  // SL・TP両方ATR連動（RR3.0）
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 0.8, rrRatio: 3.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-0.8] RR3.0" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.3, maxSl: 1.0, rrRatio: 3.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.3-1.0] RR3.0" },
  { atrPeriod: 30, mult: 3.0, minSl: 0.4, maxSl: 1.2, rrRatio: 3.0, tpFixed: 0, mode: "atr_both", label: "ATR×3.0 SL[0.4-1.2] RR3.0" },
];
