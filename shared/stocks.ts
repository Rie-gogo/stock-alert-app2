...
export const TARGET_STOCKS = [
  ...
  { symbol: '6920', ticker: '6920.T', name: 'レーザーテック',          basePrice: 22400, sector: '半導体' },   // 除外: 7/1以降0勝7敗、-158,500円
