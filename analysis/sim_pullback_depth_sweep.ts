...
console.log("押し目深さフィルタースイープ（現行仕様ベース）");
console.log("（③改+⑤適用済み、7日間）");
console.log("=".repeat(80));
console.log("");
...
const CONFIGS: SimConfig[] = [
  // 現行仕様（押し目30-70%）
  { label: "現行仕様（押し目30-70%）", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.30, pullbackMax: 0.70, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
  // 押し目20-80%（提案）
  { label: "押し目20-80%（提案）", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.20, pullbackMax: 0.80, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
  // 押し目15-85%
  { label: "押し目15-85%", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.15, pullbackMax: 0.85, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
  // 押し目10-90%
  { label: "押し目10-90%", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.10, pullbackMax: 0.90, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
  // 押し目フィルター無効
  { label: "押し目フィルター無効（0-100%）", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.0, pullbackMax: 1.0, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
  // 押し目25-75%（小幅緩和）
  { label: "押し目25-75%", blockMediumDirect: true, timeFilter: true, pullbackMin: 0.25, pullbackMax: 0.75, highVolSL: 0.5, highVolTP: 1.5, defaultSL: 0.5, defaultTP: 1.5 },
];
...
console.log("");
// 日別比較
console.log("日付       | 現行(30-70%) | 20-80%     | 15-85%     | 10-90%     | 無効(0-100%)");
console.log("-----------|------------|------------|------------|------------|------------");
for (let i = 0; i < DATES.length; i++) {
  ...
  console.log(`${d} | ${vals.slice(0, 5).join(" | ")}`);
}
