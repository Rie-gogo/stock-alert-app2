...
const sourceAuditIt = process.env.RUN_SUMCO_SOURCE_AUDIT === "1" ? it : it.skip;

describe("3436専用SHORT Git fixtureソース監査", () => {
  sourceAuditIt("DBの最新ID重複除去済み29日9,417足とfixtureが完全一致する", async () => {
    ...
    const [rawRows] = await connection.query(`
      ...
      INNER JOIN (
        ...
        FROM rt_candles
        WHERE symbol = '3436' AND tradeDate <= '2026-08-28'
