...
const REQUIRED_BY_VERSION: Record<string, string[]> = {
  ...
  [DISCO_LONG_PROFIT_PROTECTION_A_VERSION]: ["discoConfirmedBreakLong"],
  [DISCO_LONG_PRIOR_THREE_B_VERSION]: ["discoConfirmedBreakLong"],
  ...
  [SUMCO_VOLUME_110_VERSION]: ["sumcoBreakdownShort"],
  [SUMCO_TIME_15_VERSION]: ["sumcoBreakdownShort"],
  [TAIYO_AFTERNOON_RR2_VERSION]: ["taiyoAfternoonReversalShort"],
  [TAIYO_AFTERNOON_DEPTH_VERSION]: ["taiyoAfternoonReversalShort"],
  [TAIYO_AFTERNOON_LONG_RR2_VERSION]: ["taiyoAfternoonReversalLong"],
  [TAIYO_AFTERNOON_LONG_WINRATE_VERSION]: ["taiyoAfternoonReversalLong"],
